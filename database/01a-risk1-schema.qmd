...
Stores results from the GPS processing pipeline: timezone conversion, dwell time, and optional movement classification/clustering.

**Note:** Movement/cluster fields are optional - supports both point-level and cluster-based analyses.
