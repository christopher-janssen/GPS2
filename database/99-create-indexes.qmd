...
dbExecute(con, "
CREATE INDEX IF NOT EXISTS idx_osm_poi_geometry
ON public_data.osm_poi USING GIST(geometry);
")
```
...
dbExecute(con, "
CREATE INDEX IF NOT EXISTS idx_osm_landuse_geometry
ON public_data.osm_landuse USING GIST(geometry);
")
```
