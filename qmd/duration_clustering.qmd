...
clustered_19 <- cluster_stationary_gps(gps2_stationary, participant_id = 19, eps = 20)
clustered_259 <- cluster_stationary_gps(gps2_stationary, participant_id = 259, eps = 20)
```
...
map_cluster_representatives <- function(clustered_data) {
  ...
  if (nrow(clustered_data) == 0) {
    ...
    return(leaflet() %>% addTiles() %>% setView(lng = -89.4, lat = 43.1, zoom = 10))
  }
