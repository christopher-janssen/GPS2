...
This document was designed for manual review and filtering of POI types for GPS proximity analysis. For each OSM class, all type values are enumerated with counts and percentages to support decisions about which POI types are relevant for research (e.g., keeping "restaurant" but excluding "waste_basket").
